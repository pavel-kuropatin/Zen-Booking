...
@Constraint(validatedBy = EmptyOrShortInRangeValidator.class)
public @interface EmptyOrShortInRange {
     ...
     */
    String message() default "Value must be empty of short in specified range";
